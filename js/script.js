...
const translations = {
    tr: {
        ...
        aboutTitle: "Hakkımda",
        aboutDesc1: "Merhaba, ben Fırat Kuşaslan. 1998 yılında doğdum ve şu anda Denizli'de yaşıyorum. Yaklaşık 5 yıldır dijital dünyada yaratıcı çözümler üreten ve marka hikayelerini görselleştirmeye odaklanan bir tasarımcıyım.",
        aboutDesc2: "Grafik tasarım, kurumsal kimlik ve dijital içerik üretimi süreçlerinde markaların hedef kitleleriyle doğru dili kurmasına yardımcı oluyorum. Teknik yetkinliğimi estetik bir vizyonla birleştirerek her projeye özgün bir yaklaşım getiriyorum.",
    ...
    en: {
        ...
        aboutTitle: "About Me",
        aboutDesc1: "Hello, I'm Fırat Kuşaslan. Born in 1998 and currently based in Denizli, I'm a designer with 5 years of experience creating creative solutions and visualizing brand stories in the digital landscape.",
        aboutDesc2: "I help brands communicate effectively with their target audiences through graphic design, corporate identity, and digital content creation. By blending technical expertise with an aesthetic vision, I bring a unique approach to every project.",
